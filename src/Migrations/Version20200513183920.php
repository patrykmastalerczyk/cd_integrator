 ...
 */
final class Version20200513183920 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE offer_offer (offer_source INT NOT NULL, offer_target INT NOT NULL, INDEX IDX_AAFBFAD79F3A585D (offer_target), INDEX IDX_AAFBFAD786DF08D2 (offer_source), PRIMARY KEY(offer_source, offer_target)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE product_offer (product_id INT NOT NULL, offer_id INT NOT NULL, INDEX IDX_888AFC6253C674EE (offer_id), INDEX IDX_888AFC624584665A (product_id), PRIMARY KEY(product_id, offer_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
