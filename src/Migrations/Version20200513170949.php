 ...
 */
final class Version20200513170949 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE offer_product22 (product_id INT NOT NULL, offer_id INT NOT NULL, INDEX IDX_DB7FBF3D4584665A (product_id), INDEX IDX_DB7FBF3D53C674EE (offer_id), PRIMARY KEY(product_id, offer_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
